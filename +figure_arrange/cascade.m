function [] = cascade(cascade_config)
    ...
    fig_handles = figure_common.get_all_fig_handles(cascade_config.is_sorted_by_number);
    ...
    % margins
    margin_monitor = cascade_config.margin_monitor.convert_to(figure_common.unit.pixels, size_monitor);
